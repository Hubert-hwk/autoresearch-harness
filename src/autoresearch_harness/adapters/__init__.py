from .external_command import ExternalCommandExecutor
...
from .recommender_bpr import RecommenderBprExecutor


EXECUTORS = {
    "external_command": ExternalCommandExecutor,
    ...
    "recommender_bpr": RecommenderBprExecutor,
}
